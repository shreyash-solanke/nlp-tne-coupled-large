...
@Model.register("tne_coupled_transformer_attention")
class TNECoupledModel_att(Model):
    ...
    def __init__(
        ...
        #Uncomment this to expermient with follwoing loss functions

        # self.preposition_loss = torch.nn.MSELoss()
        # self.preposition_loss = torch.nn.BCEWithLogitsLoss()
